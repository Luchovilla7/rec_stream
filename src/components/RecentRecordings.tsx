...
import { Film, Eye, Link2, Trash2, Play, Copy, Check } from 'lucide-react';
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-[10px] text-zinc-500 font-mono">
            Enlace corto & Contador de vistas
          </span>
        </div>
        ...
        {recordings.length === 0 ? (
          <div className="text-center py-8 border border-dashed border-zinc-800 rounded-xl">
            ...
            <p className="text-[11px] text-zinc-600 mt-1">Graba tu pantalla para generar enlaces para compartir</p>
          </div>
        ) : (
          <div className="space-y-2.5 max-h-[190px] overflow-y-auto pr-1 custom-scrollbar">
            {recordings.map((rec) => (
              ...
              >
                ...
                <div className="flex items-center justify-between sm:justify-end gap-3 text-xs border-t sm:border-t-0 pt-2 sm:pt-0 border-zinc-800/60">
                  <div className="flex items-center gap-1.5 text-zinc-400 font-mono text-[11px]">
                    <Eye className="w-3.5 h-3.5 text-zinc-500" />
                    <span>{rec.view_count} vistas</span>
                  </div>
